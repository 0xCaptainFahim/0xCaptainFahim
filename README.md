...
└─$
I am 𝓜𝓭. 𝓕𝓪𝓱𝓲𝓶 𝓢𝓱𝓪𝓴𝓲𝓵 𝓒𝓱𝓸𝔀𝓭𝓱𝓾𝓻𝔂, a 𝒄𝒚𝒃𝒆𝒓𝒔𝒆𝒄𝒖𝒓𝒊𝒕𝒚 𝒆𝒏𝒈𝒊𝒏𝒆𝒆𝒓, developer & strategic problem solver and 𝒗𝒖𝒍𝒏𝒆𝒓𝒂𝒃𝒊𝒍𝒊𝒕𝒚 𝒓𝒆𝒔𝒆𝒂𝒓𝒄𝒉𝒆𝒓. Graduated with a B.Sc. in Computer Science & Engineering from AUST. My philosophy is simple: To truly secure a system, you must first understand exactly how it is built.
...
• Cybersecurity Researcher @ Bugcrowd & Intigriti: Specializing in Penetration Testing and Red Teaming for global clients and platforms.
...
Achieved elite global placements across 20+ prestigious Capture The Flag events: including
...
• Academic Excellence: Consistently ranked in the Top 10 throughout my early education, earning multiple academic and extracurricular achievement certificates and outstanding result awards across PEC, JSC, SSC, and HSC board exams (All Golden GPA 5).
...
🌐 Catch me on Github: https://github.com/0xCaptainFahim
